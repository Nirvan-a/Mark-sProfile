...
// 导入本地图片资源
import blackPepperBeefImg from './assets/products/Black_Pepper_Beef_Cube_Skewer.png'
import cauliflowerImg from './assets/products/Cauliflower_Floret_Skewer.png'
import chickenCartilageImg from './assets/products/Chicken_Cartilage_and_Meat_Skewer.png'
import crispyPotatoImg from './assets/products/Crispy_Potato_Slice_Skewer.png'
import cuminLambImg from './assets/products/Cumin_Lamb_Bite_Skewer.png'
import icedPlumJuiceImg from './assets/products/Iced_Plum_Juice.png'
import jasmineMilkTeaImg from './assets/products/Jasmine_Milk_Tea.png'
import lemonWaterImg from './assets/products/Lemon_Water.png'
import lotusRootImg from './assets/products/Lotus_Root_Skewer.png'
import marinatedPorkImg from './assets/products/Marinated_Pork_Loin_Skewer.png'
import sparklingLemonImg from './assets/products/Sparkling_Lemon_Water.png'
import spicyChickenImg from './assets/products/Spicy_Chicken_Tender_Skewer.png'
import sweetCornImg from './assets/products/Sweet_Corn_Segment_Skewer.png'
import taiwaneseSausageImg from './assets/products/Taiwanese_Sweet_Sausage_Skewer.png'
